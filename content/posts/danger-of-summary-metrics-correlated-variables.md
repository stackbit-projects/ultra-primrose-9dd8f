...
Numeric EDA have set of defined interpretaion(ex: positive skewness means data gathered in lower value, ) and it is easy to do things based on numeric EDA . 
